...
public class itemDetailsDto {
	...
	public itemDetailsDto(String itemId, String itemName, String orderQty, String shipQty, String deliverQty,
			String estCost, String specification, String processorName, String barCode) {
		super();
		this.itemId = itemId;
		this.itemName = itemName;
		this.orderQty = orderQty;
