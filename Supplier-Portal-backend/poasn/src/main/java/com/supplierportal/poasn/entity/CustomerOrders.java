...
public class CustomerOrders {
	...
	public CustomerOrders(long orderId, String customName, String customMobile, String deliveryType,
			Date orderDate, Date expdeliveryDate, String expdeliveryTime, String status,
